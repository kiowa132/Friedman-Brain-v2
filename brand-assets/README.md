...
| `headshot.jpg` | full standing shot vs. textured wall (Kyle's original) | "with Kyle" reference; needs the full body |
| `headshot-crop.jpg` | shoulders-up crop of the above | face reference |
